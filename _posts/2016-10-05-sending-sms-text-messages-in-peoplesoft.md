...
[<img class="alignnone size-full wp-image-705" src="/assets/images/2016/10/Picture1.png" alt="Picture1" width="1210" height="734" srcset="/assets/images/2016/10/Picture1.png 1210w, /assets/images/2016/10/Picture1-300x182.png 300w, /assets/images/2016/10/Picture1-768x466.png 768w, /assets/images/2016/10/Picture1-1024x621.png 1024w, /assets/images/2016/10/Picture1-626x380.png 626w" sizes="(max-width: 1210px) 100vw, 1210px" />](/assets/images/2016/10/Picture1.png)
...
[<img class="alignnone size-full wp-image-707" src="/assets/images/2016/10/Picture3.png" alt="Picture3" width="1183" height="976" srcset="/assets/images/2016/10/Picture3.png 1183w, /assets/images/2016/10/Picture3-300x248.png 300w, /assets/images/2016/10/Picture3-768x634.png 768w, /assets/images/2016/10/Picture3-1024x845.png 1024w, /assets/images/2016/10/Picture3-461x380.png 461w" sizes="(max-width: 1183px) 100vw, 1183px" />](/assets/images/2016/10/Picture3.png)

Make note of the sender ID that is assigned to your account. This will be the number that the SMS messages will come from.

[<img class="alignnone size-full wp-image-708" src="/assets/images/2016/10/Picture4.png" alt="Picture4" width="974" height="398" srcset="/assets/images/2016/10/Picture4.png 974w, /assets/images/2016/10/Picture4-300x123.png 300w, /assets/images/2016/10/Picture4-768x314.png 768w, /assets/images/2016/10/Picture4-930x380.png 930w" sizes="(max-width: 974px) 100vw, 974px" />](/assets/images/2016/10/Picture4.png)
...
[<img class="alignnone size-full wp-image-709" src="/assets/images/2016/10/Picture5.png" alt="Picture5" width="776" height="616" srcset="/assets/images/2016/10/Picture5.png 776w, /assets/images/2016/10/Picture5-300x238.png 300w, /assets/images/2016/10/Picture5-768x610.png 768w, /assets/images/2016/10/Picture5-479x380.png 479w" sizes="(max-width: 776px) 100vw, 776px" />](/assets/images/2016/10/Picture5.png)

Then you will need to import the root and intermediate certificates into PSKeyManager.  The whole process of importing third-party SSL certificates into PeopleSoft is already nicely <a href="http://nirajpatil-psadmin.blogspot.com/2012/09/psoft-third-party-integration-using.html" target="_blank">documented here by Niraj Patil</a>, so I suggest following the steps in that post to import the certificates. Alternatively, you can [click here to download a Word doc version with pictures](/assets/downloads/Integration_with_a_3rd_Party_utilizing_Digital_Certificates_v4.doc).

**Importing Custom Objects**

I have created an app designer project that contains all of the necessary objects to invoke the SMS API web service via Integration Broker in PeopleSoft. [Click here to download the app designer project](/assets/downloads/PSM_NEXMO.zip).  After importing the project into app designer, you can login to the PIA to view the newly imported service operation that will be used for sending SMS messages.  The service operation is located at PeopleTools->Integration Broker->Integration Setup->Service Operations. The service operation is named “SENDSMS_GET”. You can click on the “View Message” link to see the document template that will get populated when invoking the service.

[<img class="alignnone size-full wp-image-710" src="/assets/images/2016/10/Picture6.png" alt="Picture6" width="849" height="482" srcset="/assets/images/2016/10/Picture6.png 849w, /assets/images/2016/10/Picture6-300x170.png 300w, /assets/images/2016/10/Picture6-768x436.png 768w, /assets/images/2016/10/Picture6-669x380.png 669w" sizes="(max-width: 849px) 100vw, 849px" />](/assets/images/2016/10/Picture6.png)
...
[<img class="alignnone size-full wp-image-711" src="/assets/images/2016/10/Picture7.png" alt="Picture7" width="434" height="447" srcset="/assets/images/2016/10/Picture7.png 434w, /assets/images/2016/10/Picture7-291x300.png 291w, /assets/images/2016/10/Picture7-369x380.png 369w" sizes="(max-width: 434px) 100vw, 434px" />](/assets/images/2016/10/Picture7.png)
...
[<img class="alignnone size-full wp-image-713" src="/assets/images/2016/10/Picture9.png" alt="Picture9" width="599" height="383" srcset="/assets/images/2016/10/Picture9.png 599w, /assets/images/2016/10/Picture9-300x192.png 300w, /assets/images/2016/10/Picture9-594x380.png 594w" sizes="(max-width: 599px) 100vw, 599px" />](/assets/images/2016/10/Picture9.png)
...
[<img class="alignnone size-full wp-image-714" src="/assets/images/2016/10/Picture10.png" alt="Picture10" width="513" height="428" srcset="/assets/images/2016/10/Picture10.png 513w, /assets/images/2016/10/Picture10-300x250.png 300w, /assets/images/2016/10/Picture10-455x380.png 455w" sizes="(max-width: 513px) 100vw, 513px" />](/assets/images/2016/10/Picture10.png)
...
[<img class="alignnone size-full wp-image-715" src="/assets/images/2016/10/Picture11.png" alt="Picture11" width="673" height="465" srcset="/assets/images/2016/10/Picture11.png 673w, /assets/images/2016/10/Picture11-300x207.png 300w, /assets/images/2016/10/Picture11-550x380.png 550w" sizes="(max-width: 673px) 100vw, 673px" />](/assets/images/2016/10/Picture11.png)
...
[<img class="alignnone size-full wp-image-716" src="/assets/images/2016/10/Picture12.png" alt="Picture12" width="736" height="412" srcset="/assets/images/2016/10/Picture12.png 736w, /assets/images/2016/10/Picture12-300x168.png 300w, /assets/images/2016/10/Picture12-679x380.png 679w" sizes="(max-width: 736px) 100vw, 736px" />](/assets/images/2016/10/Picture12.png)
