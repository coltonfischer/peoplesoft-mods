...
[<img class="alignnone size-full wp-image-640" src="/assets/images/2016/09/1extract.png" alt="extract" width="549" height="245" srcset="/assets/images/2016/09/1extract.png 549w, /assets/images/2016/09/1extract-300x134.png 300w" sizes="(max-width: 549px) 100vw, 549px" />](/assets/images/2016/09/1extract.png)
...
[<img class="alignnone size-full wp-image-641" src="/assets/images/2016/09/2customfolder.png" alt="customfolder" width="616" height="342" srcset="/assets/images/2016/09/2customfolder.png 616w, /assets/images/2016/09/2customfolder-300x167.png 300w" sizes="(max-width: 616px) 100vw, 616px" />](/assets/images/2016/09/2customfolder.png)

Take the folder named “DataMaskingFilter” and place it in the following directory:

<pre> %PS_HOME%\sdk</pre>

[<img class="alignnone size-full wp-image-642" src="/assets/images/2016/09/3dmffolder.png" alt="dmffolder" width="647" height="352" srcset="/assets/images/2016/09/3dmffolder.png 647w, /assets/images/2016/09/3dmffolder-300x163.png 300w" sizes="(max-width: 647px) 100vw, 647px" />](/assets/images/2016/09/3dmffolder.png)
...
[<img class="alignnone size-full wp-image-643" src="/assets/images/2016/09/3webxml.png" alt="webxml" width="675" height="350" srcset="/assets/images/2016/09/3webxml.png 675w, /assets/images/2016/09/3webxml-300x156.png 300w" sizes="(max-width: 675px) 100vw, 675px" />](/assets/images/2016/09/3webxml.png)
...
[<img class="alignnone size-full wp-image-644" src="/assets/images/2016/09/4dmfwebxml.png" alt="dmfwebxml" width="680" height="353" srcset="/assets/images/2016/09/4dmfwebxml.png 680w, /assets/images/2016/09/4dmfwebxml-300x156.png 300w" sizes="(max-width: 680px) 100vw, 680px" />](/assets/images/2016/09/4dmfwebxml.png)
...
[<img class="alignnone size-full wp-image-645" src="/assets/images/2016/09/5webprofile.png" alt="webprofile" width="806" height="258" srcset="/assets/images/2016/09/5webprofile.png 806w, /assets/images/2016/09/5webprofile-300x96.png 300w, /assets/images/2016/09/5webprofile-768x246.png 768w" sizes="(max-width: 806px) 100vw, 806px" />](/assets/images/2016/09/5webprofile.png)
...
[<img class="alignnone size-full wp-image-646" src="/assets/images/2016/09/6Relationships.png" alt="Relationships" width="1214" height="468" srcset="/assets/images/2016/09/6Relationships.png 1214w, /assets/images/2016/09/6Relationships-300x116.png 300w, /assets/images/2016/09/6Relationships-768x296.png 768w, /assets/images/2016/09/6Relationships-1024x395.png 1024w, /assets/images/2016/09/6Relationships-986x380.png 986w" sizes="(max-width: 1214px) 100vw, 1214px" />](/assets/images/2016/09/6Relationships.png)

Similarly, I got the following when I went to the Add/Update a Person Page:

[<img class="alignnone size-full wp-image-647" src="/assets/images/2016/09/6AddUpdatePerson.png" alt="AddUpdatePerson" width="1075" height="505" srcset="/assets/images/2016/09/6AddUpdatePerson.png 1075w, /assets/images/2016/09/6AddUpdatePerson-300x141.png 300w, /assets/images/2016/09/6AddUpdatePerson-768x361.png 768w, /assets/images/2016/09/6AddUpdatePerson-1024x481.png 1024w, /assets/images/2016/09/6AddUpdatePerson-809x380.png 809w" sizes="(max-width: 1075px) 100vw, 1075px" />](/assets/images/2016/09/6AddUpdatePerson.png)

I also tested the html output of a PS Query that returned SSNs.

[<img class="alignnone size-full wp-image-648" src="/assets/images/2016/09/7selectquery.png" alt="selectquery" width="1024" height="343" srcset="/assets/images/2016/09/7selectquery.png 1024w, /assets/images/2016/09/7selectquery-300x100.png 300w, /assets/images/2016/09/7selectquery-768x257.png 768w" sizes="(max-width: 1024px) 100vw, 1024px" />](/assets/images/2016/09/7selectquery.png)

The output of the query only showed masked SSNs.

[<img class="alignnone size-full wp-image-649" src="/assets/images/2016/09/8viewquery.png" alt="viewquery" width="1580" height="368" srcset="/assets/images/2016/09/8viewquery.png 1580w, /assets/images/2016/09/8viewquery-300x70.png 300w, /assets/images/2016/09/8viewquery-768x179.png 768w, /assets/images/2016/09/8viewquery-1024x239.png 1024w, /assets/images/2016/09/8viewquery-1180x275.png 1180w" sizes="(max-width: 1580px) 100vw, 1580px" />](/assets/images/2016/09/8viewquery.png)
