...
[<img class="alignnone size-full wp-image-615" src="/assets/images/2016/08/Trusted_IP.png" alt="Trusted_IP" width="736" height="196" srcset="/assets/images/2016/08/Trusted_IP.png 736w, /assets/images/2016/08/Trusted_IP-300x80.png 300w" sizes="(max-width: 736px) 100vw, 736px" />](/assets/images/2016/08/Trusted_IP.png)

I created a table in the database to store the information.

[<img class="alignnone size-full wp-image-616" src="/assets/images/2016/08/TRUSTED_IP_TABLE.png" alt="TRUSTED_IP_TABLE" width="418" height="267" srcset="/assets/images/2016/08/TRUSTED_IP_TABLE.png 418w, /assets/images/2016/08/TRUSTED_IP_TABLE-300x192.png 300w" sizes="(max-width: 418px) 100vw, 418px" />](/assets/images/2016/08/TRUSTED_IP_TABLE.png)
...
[<img class="alignnone size-full wp-image-617" src="/assets/images/2016/08/APP_PKG.png" alt="APP_PKG" width="426" height="168" srcset="/assets/images/2016/08/APP_PKG.png 426w, /assets/images/2016/08/APP_PKG-300x118.png 300w" sizes="(max-width: 426px) 100vw, 426px" />](/assets/images/2016/08/APP_PKG.png)
...
[<img class="alignnone size-full wp-image-618" src="/assets/images/2016/08/Service.png" alt="Service" width="837" height="621" srcset="/assets/images/2016/08/Service.png 837w, /assets/images/2016/08/Service-300x223.png 300w, /assets/images/2016/08/Service-768x570.png 768w, /assets/images/2016/08/Service-512x380.png 512w" sizes="(max-width: 837px) 100vw, 837px" />](/assets/images/2016/08/Service.png)
...
[<img class="alignnone size-full wp-image-619" src="/assets/images/2016/08/Event_Mapping.png" alt="Event_Mapping" width="740" height="236" srcset="/assets/images/2016/08/Event_Mapping.png 740w, /assets/images/2016/08/Event_Mapping-300x96.png 300w" sizes="(max-width: 740px) 100vw, 740px" />](/assets/images/2016/08/Event_Mapping.png)
...
[<img class="alignnone size-full wp-image-620" src="/assets/images/2016/08/CREF.png" alt="CREF" width="324" height="629" srcset="/assets/images/2016/08/CREF.png 324w, /assets/images/2016/08/CREF-155x300.png 155w, /assets/images/2016/08/CREF-196x380.png 196w" sizes="(max-width: 324px) 100vw, 324px" />](/assets/images/2016/08/CREF.png)
...
[<img class="alignnone size-full wp-image-621" src="/assets/images/2016/08/MAP_EVENT.png" alt="MAP_EVENT" width="899" height="517" srcset="/assets/images/2016/08/MAP_EVENT.png 899w, /assets/images/2016/08/MAP_EVENT-300x173.png 300w, /assets/images/2016/08/MAP_EVENT-768x442.png 768w, /assets/images/2016/08/MAP_EVENT-661x380.png 661w" sizes="(max-width: 899px) 100vw, 899px" />](/assets/images/2016/08/MAP_EVENT.png)
...
After performing the previous steps, when I attempt to access the “Change My Password” content reference from an untrusted IP address, I get the following message.[<img class="alignnone size-full wp-image-622" src="/assets/images/2016/08/Unauthorized.png" alt="Unauthorized" width="959" height="448" srcset="/assets/images/2016/08/Unauthorized.png 959w, /assets/images/2016/08/Unauthorized-300x140.png 300w, /assets/images/2016/08/Unauthorized-768x359.png 768w, /assets/images/2016/08/Unauthorized-813x380.png 813w" sizes="(max-width: 959px) 100vw, 959px" />](/assets/images/2016/08/Unauthorized.png)
...
[<img class="alignnone size-full wp-image-623" src="/assets/images/2016/08/UNTRUSTED_IP.png" alt="UNTRUSTED_IP" width="855" height="354" srcset="/assets/images/2016/08/UNTRUSTED_IP.png 855w, /assets/images/2016/08/UNTRUSTED_IP-300x124.png 300w, /assets/images/2016/08/UNTRUSTED_IP-768x318.png 768w" sizes="(max-width: 855px) 100vw, 855px" />](/assets/images/2016/08/UNTRUSTED_IP.png)
